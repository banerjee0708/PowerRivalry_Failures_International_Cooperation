...
def main():
    ...
    fig = pylab.gcf()
    fig.canvas.manager.set_window_title('Figure 12: Comparisons of Public Good Provision and Welfare')
    ...
    fig = pylab.gcf()
    fig.canvas.manager.set_window_title('Figure 13: Comparisons of Individual Provision and Welfare')
