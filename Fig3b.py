...
from functionsFig3b import function_looper_endog,check_r_arrays
...
def main():
    ...
    # Show the plot
    plt.savefig('Figure 3 Panel (Right): Comparisons of total and individual provision under soft power (left) and under only rival power (right).png')
    plt.show()
