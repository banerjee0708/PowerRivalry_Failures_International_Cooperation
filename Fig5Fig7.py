...
def main():
    ...
    fig = pylab.gcf()
    fig.canvas.manager.set_window_title('Figure 5: Comparisons of Public Good Provision and Welfare')
    ...
    fig = pylab.gcf()
    fig.canvas.manager.set_window_title('Figure 7: Comparisons of Individual Provision and Welfare')
    ...
    # Show the plot
    fig1.savefig('Figure 5 - Comparisons of Public Good Provision and Welfare.png')
    fig2.savefig('Figure 7 - Comparisons of Individual Provision and Welfare.png')
    plt.show()
