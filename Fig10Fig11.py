...
def main():
    ...
    fig = pylab.gcf()
    fig.canvas.manager.set_window_title('Figure 10: Comparisons of Public Good Provision and Welfare')
    fig1.suptitle('Initial wealths: [5000, 500]')
    ...
    fig = pylab.gcf()
    fig.canvas.manager.set_window_title('Figure 11: Comparisons of Individual Provision and Welfare')
    fig2.suptitle('Initial wealths: [5000, 500]')
    ...
    # Show the plot
    fig1.savefig('Figure 10 - Comparisons of Public Good Provision and Welfare.png')
    fig2.savefig('Figure 11 - Comparisons of Individual Provision and Welfare.png')
    plt.show()
