...
def main():
    ...
    axs2[0].plot(average_wealth, rw_sum_welfare_nash, label='Welfare: Nash', color='red', marker='o')
    axs2[0].set_title('Total Welfare: Soc Planner and Nash')
    axs2[0].set_xlabel('Average total group wealth')
    axs2[0].set_ylabel('Welfare')
    axs2[0].legend(loc="lower right")

    axs2[1].plot(average_wealth, diff_soc_nash_rw, label='Relative Difference', color='black', marker='o')
    axs2[1].set_title('(Welfare Soc Planner - Nash) / Nash')
    axs2[1].set_xlabel('Average total group wealth')
    axs2[1].set_ylabel('Welfare')
